...
export const MusicIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 9l10.5-3m0 6.553v3.75a2.25 2.25 0 01-1.07 1.916l-7.5 4.25a2.25 2.25 0 01-2.36 0L3.32 16.166a2.25 2.25 0 01-1.07-1.916V8.25a2.25 2.25 0 011.07-1.916l7.5-4.25a2.25 2.25 0 012.36 0L19.5 7.5H9" />
    </svg>
);
